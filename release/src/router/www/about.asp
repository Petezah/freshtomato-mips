...
<content>
    ...
    <div class="fluid-grid x3">
        <div class="box">
            <div class="heading">Tomato Firmware <% version(1); %></div>
            <div class="content">
                <p>
                    <!-- USB-BEGIN -->
                    ...
                    support for additional router models, dual-band and Wireless-N mode.</p>
        ...
        <div class="box">
            <div class="heading">AdvancedTomato</div>
            <div class="content">
        ...
        <!-- OPENVPN-BEGIN -->
        <div class="box">
            <div class="heading">OpenVPN integration and GUI</div>
            <div class="content">
        ...
        <!-- VPN-BEGIN -->
        <div class="box">
            <div class="heading">"JYAvenard" features</div>
            <div class="content">
                <p>
                    <!-- OPENVPN-BEGIN -->
        ...
        <div class="box">
            <div class="heading">"Victek" features</div>
            <div class="content">
                <p>
                    - Extended Sysinfo<br>
                    <!-- NOCAT-BEGIN -->
        ...
        <div class="box">
            <div class="heading">"Teaman" features</div>
            <div class="content">
                <p>
        ...
        <div class="box">
            <div class="heading">"Lancethepants" features</div>
            <div class="content">
                <p>
                    <!-- DNSSEC-BEGIN -->
        ...
        <div class="box">
            <div class="heading">"Toastman" features</div>
            <div class="content">
                <p>
        ...
        <div class="box">
            <div class="heading">"Tiomo" features</div>
            <div class="content">
                <p>
        ...
        <!-- SDHC-BEGIN -->
        <div class="box">
            <div class="heading">"Slodki" feature</div>
            <div class="content">
                <p>
        ...
        <div class="box">
            <div class="heading">"Victek/PrinceAMD/Phykris/Shibby" feature</div>
            <div class="content">
    ...
    <div class="box box-fluid">
        <div class="content">
            ...
            <h4>Based on Tomato Firmware v1.28</h4>
            <p>
